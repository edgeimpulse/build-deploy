...
exports.download_model = exports.wait_for_job_completion = exports.get_stdout = exports.build_model = void 0;
const axios_1 = __importStar(__nccwpck_require__(8757)); // eslint-disable-line import/named
function build_model(project_id, deploy_type, api_key, impulse_id, engine, modelType) {
...
exports.build_model = build_model;
function get_stdout(project_id, job_id, api_key, skip_line_no) {
    return __awaiter(this, void 0, void 0, function* () {
...
exports.get_stdout = get_stdout;
function wait_for_job_completion(project_id, job_id, api_key) {
    return __awaiter(this, void 0, void 0, function* () {
        let skip_line_no = 0;
        ...
        return new Promise((resolve, reject) => {
            const pollJobStatus = () => __awaiter(this, void 0, void 0, function* () {
                try {
                    const response = yield axios_1.default.get(url, { headers });
                    const body = response.data;
                    if (!body.success) {
                    ...
                    const stdout = yield get_stdout(project_id, job_id, api_key, skip_line_no);
...
exports.download_model = download_model;
...
const build_deploy_1 = __nccwpck_require__(6762);
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const job_id = yield (0, build_deploy_1.build_model)(project_id, deploy_type, api_key, impulse_id, engine, model_type);
